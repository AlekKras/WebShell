...
defmodule WebShell.Plumber do
  ...
  # Get files that were created by previous runs of WebShell.
  defp find_existing_pipes() do
    {:ok, files} = File.ls(WebShell.Config.log_dir)
  ...
  defp schedule_expiration(pipe_id) do
    if duration = WebShell.Config.pipe_expiration do
